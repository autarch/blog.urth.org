...
- Net-CIDR: Depends on exactly how it's used before the 0.25 release. Upgrade now.
...
{{% notice info %}} **This distribution was vulnerable prior to its 0.25 release made on
2025-05-23.** {{% /notice %}}
